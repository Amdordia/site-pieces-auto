...
// =========================================================
// 5. DÉFINITION GLOBALE DES MODÈLES DE DONNÉES
// =========================================================
...
const PieceSchema = new mongoose.Schema({
    ...
    // Pour l'instant on stocke les URL des images, on verra l'upload plus tard
    images: [String],
...
app.post('/api/pieces', authMiddleware, async (req, res) => {
  try {
...
app.put('/api/pieces/:id', authMiddleware, async (req, res) => {
  try {
    const { id } = req.params;
    const pieceMiseAJour = await Piece.findByIdAndUpdate(
      id, 
      req.body, // Remplace toutes les informations par celles envoyées
